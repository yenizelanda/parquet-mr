...
public class TestDiffBitPacking {
	...
	private void control(int[] ints) throws IOException {
		...
		DiffBitPackingValuesWriter dvw = new DiffBitPackingValuesWriter(50,
				mode);
		...
		DiffBitPackingValuesReader dvr = new DiffBitPackingValuesReader();
