 ...
 * 
 * A ValuesReader is provided with a page (byte-array) and is responsible for
...
public abstract class ValuesReader {
	 ...
	 * 
	 * The underlying implementation knows how much data to read, so a length is
	 * not provided.
	 * 
	 ...
	 * @param page
	 *            the array to read from containing the page data (repetition
	 *            levels, definition levels, data)
	 * @param offset
	 *            where to start reading from in the page
	 * @return the offset of the end of the data for this section of the page
	 * @throws IOException
	 */
	public abstract int initFromPage(long valueCount, byte[] page, int offset)
			throws IOException;
